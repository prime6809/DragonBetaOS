...
InFID           rmb     1		; input file id
OutFID          rmb     1		; output file id
...
start           stx     <ParamPtr	; save parameter pointer
                lda     #READ.		; open specified file for read
                os9     I$Open		; go open it
                bcc     L003C		; no error, skip on
		
L0039           os9     F$Exit		; otherwise exit with error

L003C           sta     <InFID		; save input file id
                stx     <ParamPtr	; save updated parameter pointer
		
                lda     #WRITE.		; create output file
                ldb     #SHARE.+PEXEC.+PWRIT.+PREAD.+EXEC.+UPDAT.
                os9     I$Create	; go create it
                bcs     L0039		; error, exit
		
                sta     <OutFID		; save output file id
